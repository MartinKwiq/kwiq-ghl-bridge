...
export const INTERVIEW: { version: string; sections: SectionDef[] } = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { id: "ia_nombre", label: "Nombre del asistente (ej. Sofía, Bruno)", type: "text_short", output: { target: "conversation_ai_prompt", key: "persona.name" } },
        ...
        { id: "ia_idioma", label: "Idioma principal de respuesta", type: "text_short", output: { target: "conversation_ai_prompt", key: "language" } },
      ],
    },
  ],
};
